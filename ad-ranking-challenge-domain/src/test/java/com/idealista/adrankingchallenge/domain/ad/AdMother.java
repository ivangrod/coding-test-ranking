...
public class AdMother {
  ...
  public static Ad adEmpty() {
    return Ad.createAd(1, Typology.FLAT, StringUtils.EMPTY, Collections.emptyList(), 0, 0);
  }

  public static Ad adWithoutPictures() {
    return Ad.createAd(1, Typology.FLAT, "Beautiful house", Collections.emptyList(), 0, 0);
  }

  public static Ad adWithAnHDPicture() {
    return Ad.createAd(1, Typology.FLAT, "Beautiful house", Collections
  ...
  public static Ad adWithTwoHDPictures() {
    ...
    return Ad.createAd(1, Typology.FLAT, "Beautiful house", twoHDPictures, 0, 0);
  }
  ...
  public static Ad adWithASDPictureAndAHDPicture() {
    ...
    return Ad.createAd(1, Typology.FLAT, "Beautiful house", aHDPictureAndASDPicture, 0, 0);
  }
  ...
  public static Ad adWithoutDescription() {
    return Ad.createAd(1, Typology.FLAT, "", Collections.emptyList(), 0, 0);
  }

  public static Ad adFlatWithThirtyWordsInTheDescription() {
    return Ad.createAd(1, Typology.FLAT, createDescriptionWithWords(30), Collections.emptyList(),
                       0, 0);
  }

  public static Ad adFlatWithNineteenWordsInTheDescription() {
    return Ad.createAd(1, Typology.FLAT, createDescriptionWithWords(19), Collections.emptyList(),
                       0, 0);
  }

  public static Ad adFlatWithFiftyWordsInTheDescription() {
    return Ad.createAd(1, Typology.FLAT, createDescriptionWithWords(50), Collections.emptyList(),
                       0, 0);
  }

  public static Ad adChaletWithFiftyWordsInTheDescription() {
    return Ad.createAd(1, Typology.CHALET, createDescriptionWithWords(50), Collections.emptyList(),
                       0, 0);
  }

  public static Ad adGarageWithDescriptionContainingTheWords(List<String> keywordInDescription) {
    return Ad.createAd(1, Typology.GARAGE,
  ...
  public static Ad adFlatComplete() {
    return Ad.createAd(1, Typology.FLAT, createDescriptionWithWords(10), Collections
                           .singletonList(new Picture(1, "http://www.idealista.com/pictures/1", Definition.HD)),
                       85, 0);
  }

  public static Ad adChaletComplete() {
    return Ad.createAd(1, Typology.CHALET, createDescriptionWithWords(10), Collections
                           .singletonList(new Picture(1, "http://www.idealista.com/pictures/1", Definition.HD)),
                       85, 120);
  }
  ...
  public static Ad adChaletCompleteWithThreeHDPictures() {
    ...
    return Ad.createAd(1, Typology.CHALET, createDescriptionWithWords(50),
                       threeHDPictures, 85, 120);
  }

  public static Ad adGarageWithDescriptionComplete() {
    return Ad.createAd(1, Typology.GARAGE, createDescriptionWithWords(10), Collections
                           .singletonList(new Picture(1, "http://www.idealista.com/pictures/1", Definition.HD)),
                       0, 0);
  }

  public static Ad adGarageWithoutDescriptionComplete() {
    return Ad.createAd(1, Typology.GARAGE, StringUtils.EMPTY, Collections
  ...
  public static Ad adFlatWithHDPictureAndFiftyWordsInTheDescription() {
    List<Picture> aHDPicture = Arrays
        .asList(new Picture(1, "http://www.idealista.com/pictures/1", Definition.HD));
    return Ad.createAd(1, Typology.FLAT, createDescriptionWithWords(50), aHDPicture, 0, 0);
  }
